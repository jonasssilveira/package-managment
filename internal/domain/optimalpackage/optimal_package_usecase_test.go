...
//			input: dto.Packages{Packages: []dto.Package{{500}}},
//			mockRepo: &mock.MockPackRepository{
//				AddPacksMock: func(ctx context.Context, packEntity []entity.PackDocument) {
//				},
//			},
//			mockError: nil,
//		},
...
//			input: dto.Packages{Packages: []dto.Package{{1000}}},
//			mockRepo: &mock.MockPackRepository{
//				AddPacksMock: func(ctx context.Context, packEntity []entity.PackDocument) {
//				},
//			},
...
//	for _, tt := range tests {
//		t.Run(tt.name, func(t *testing.T) {
//			usecase := NewPackageUseCase(tt.mockRepo)
//			usecase.Add(context.Background(), tt.input)
//
//			if tt.mockError != nil {
//				require.Error(t, err)
